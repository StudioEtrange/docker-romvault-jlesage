...
This image is replaced by a better one based on linuxserver.io images into [StudioEtrange/docker-romvault](https://github.com/StudioEtrange/docker-romvault)
...
docker run -d \
    ...
    --shm-size 2g \
    studioetrange/romvault-jlesage
```
...
services:
  romvault:
    image: studioetrange/romvault-jlesage
    ports:
      - "5800:5800"
    volumes:
...
```
docker pull studioetrange/romvault-jlesage
```
...
container image.
  ...
  3.  In the search bar, type the name of the container (`studioetrange/romvault-jlesage`).
